 ...
 */
package com.codezlab.http_logger.internal.ui;
...
import com.codezlab.http_logger.R;
import com.codezlab.http_logger.internal.data.ChuckContentProvider;
import com.codezlab.http_logger.internal.data.HttpTransaction;
import com.codezlab.http_logger.internal.data.LocalCupboard;
import com.codezlab.http_logger.internal.support.FormatUtils;
import com.codezlab.http_logger.internal.support.SimpleOnPageChangedListener;
...
public class TransactionActivity extends BaseChuckActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitleTextColor(getResources().getColor(R.color.chuck_colorAccent));
        ...
        tabLayout.setTabTextColors(ColorStateList.valueOf(getResources().getColor(R.color.chuck_colorAccent)));
