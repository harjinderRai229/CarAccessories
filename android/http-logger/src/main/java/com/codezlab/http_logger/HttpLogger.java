...
import com.codezlab.http_logger.internal.support.NotificationHelper;
import com.codezlab.http_logger.internal.support.RetentionManager;
...
import okio.Okio;
    ...
    public final class HttpLogger implements Interceptor {
         ...
         * @return The {@link HttpLogger} instance.
         */
        public HttpLogger showNotification(boolean show) {
         ...
         * @return The {@link HttpLogger} instance.
         */
        public HttpLogger maxContentLength(long max) {
         ...
         * @return The {@link HttpLogger} instance.
         */
        public HttpLogger retainDataFor(Period period) {
