...
const SignUp = () => {
  ...
  const handleCreateUser = async () => {
    ...
    if (response.data.status == 'success') {
      ...
      // console.log(response.data.data.user.is_verified);
      // console.log(response.data.data.user.is_active);
      // console.log(response.data.data.user.is_deleted);
      // console.log(response.data.data.user.is_blocked);
      // console.log(response.data.data.user.is_verified);
