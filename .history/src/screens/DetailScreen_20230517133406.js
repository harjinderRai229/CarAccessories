...
import { StyleSheet, Text, View, Image, ActivityIndicator, TouchableOpacity, ScrollView, FlatList } from 'react-native';
...
const CardDetail = ({ route }) => {
  ...
  return (
    ...
    <View style={styles.imageContainer}>
      <Image style={styles.image} source={{ uri: product.imageUrl[0] }} /><FlatList
  horizontal
  pagingEnabled
