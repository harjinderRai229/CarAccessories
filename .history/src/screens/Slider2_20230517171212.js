     ...
     <View style={styles.container}>
      ...
      />
       <View style={styles.contentContainer}>
        <Text style={styles.title}>{da.prodName}</Text>
        <Text style={styles.description}>{da.description}</Text>
        ...
        <View style={styles.daDetailsContainer}>
          <Text style={styles.daDetailsTitle}>da Details</Text>
          <Text style={styles.daDetailsText}>{da.productDetails}</Text>
        </View>
      </View>
    </View>
   </ScrollView>
