...
const AddToCartScreen = ({ route ,handleRemoveFromCart}) => {
  ...
  const handleRemoveFromCart = async () => {
    try {
      ...
      const response = await api.delete('/accessories/removeFromCarts', requestBody);
    ...
    <View style={styles.container}>
      ...
      {Array.isArray(product.imageUrl) && product.imageUrl.length > 0 ? (
        ...
        <View style={styles.quantityContainer}>
          <Text style={styles.price}>Quantity: 1</Text>
