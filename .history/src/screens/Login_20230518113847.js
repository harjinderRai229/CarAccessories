...
const Login = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <TouchableOpacity style={{width:100,padding:20,heightL:70, backgroundColor:'black',borderRadius:25}} onPress={handleLogin}>
        <Text style={{color:'white',textAlign:'center', fontSize:10}}>Login</Text>
      </TouchableOpacity>
