...
const AddToCartScreen = ({ route,details }) => {
     ...
     <View style={styles.quantityContainer}>
            ...
            <View style={styles.quantityInput}>
              <Text>1</Text>
                    ...
                    <Text style={styles.price}>{product.price} harry</Text>
          </View>

    
    
    
     <View style={{flexDirection:'row' , justifyContent:'space-around',  borderTopWidth:.5 , height:40}}>
