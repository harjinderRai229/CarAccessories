...
const CardDetail = ({
  ...
  const handleAddToCart = async (cartItems, cartId) => {
    try {
      ...
      // Make the API request to add the accessories to the cart
      const response = await api.post('/accessories/addToCart', { cartItems });
  
      // Handle the API response if needed
      console.log(response.data);
  
      // Navigate to the 'AddToCartScreen' if necessary
      navigation.navigate('AddToCartScreen', { cartId });
    } catch (error) {
