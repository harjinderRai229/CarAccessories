...
const styles = StyleSheet.create({
  ...
  In the code above, a parent View component is added to wrap the password input and the password icon. This allows us to position the password icon absolutely using position: 'absolute'. The right property is used to position it at the top right corner of the password input.
  
  Then, a TouchableOpacity component is added for the "forgot password" link. It is positioned absolutely at the bottom right corner using position: 'absolute', bottom: -20, and right: 0. Adjust the bottom value according to your preference.
  
  The "forgot password" link can be further customized with your desired styles and logic for handling the forgot password action.
