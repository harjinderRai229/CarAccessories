...
import { StyleSheet, Text, View, Image, ActivityIndicator, TouchableOpacity, FlatList, ScrollView } from 'react-native';
...
const CardDetail = ({ route }) => {
  ...
  const handleAddToCart = () => {
    // Pass the product data to the "Add to Cart" screen
...
import React, { useEffect, useState } from 'react';
import { StyleSheet, Text, View, Image, ActivityIndicator, TouchableOpacity, FlatList, ScrollView, ToastAndroid } from 'react-native';
import { SliderBox } from 'react-native-image-slider-box';
...
const CardDetail = ({ route }) => {
  ...
  const addToCart = () => {
    navigation.navigate('AddToCart',{ productId: item.productId });
   ...
   <ScrollView style={{flex:1,backgroundColor:'white'}}>
     <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.button} onPress={ad}>
            <Text style={styles.buttonText}>Add To Cart</Text>
          </TouchableOpacity>
