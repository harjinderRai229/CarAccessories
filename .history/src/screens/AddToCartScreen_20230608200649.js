...
const AddToCartScreen = ({ route }) => {
  ...
  const ha = async (cartId) => {
    try {
      ...
      // Make the API request to remove the item from the cart
      const response = await api.post('/accessories/removeFromCarts', {
        cartId: cartId
      });
  ...
  // Usage:
  const cartId = '64808b25cf154e2a110c01f1';
