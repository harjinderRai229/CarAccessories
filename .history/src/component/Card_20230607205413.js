...
const Card = ({ item }) => {
    ...
    const [iconColor, setIconColor] = useState('#000'); // Initial color is black

    const toggleIconColor = () => {
      const newColor = iconColor === '#000' ? '#FF0000' : '#000'; // Toggle between red and white
    ...
    return (
        <TouchableOpacity style={styles.cardContainer} onPress={handleViewPress}>
            ...
            <TouchableOpacity style={styles.wishBtn}
                ...
                <Icon name="heart-outline" size={20} color={{tint :iconColor}} />
            </TouchableOpacity>
