...
const Card = ({ item }) => {
    ...
    const handleViewPress = () => {
        navigation.navigate('CardDetail', { product: item }); // Navigate to the CardDetail screen and pass the product as a parameter
    };
    return (
        <View style={styles.cardContainer}>
            ...
            <View style={styles.innerContainer}>
                <TouchableOpacity style={styles.btn1} onPress={ha}>
