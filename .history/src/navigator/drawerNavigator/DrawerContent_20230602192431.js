...
const DrawerContent = ({ navigation }) => {
  const handleLogout = () => {
    ...
    Error: Objects are not valid as a React child (found: object with keys {accessToken, id, fname, lname, mobile_num}). If you meant to render a collection of children, use an array instead.
